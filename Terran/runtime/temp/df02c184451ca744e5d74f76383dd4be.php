<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin\view\settings\general.html";i:1512525352;s:41:"./application/admin\view\public\base.html";i:1512537585;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
				 ...
				 <div id="thumb">
		                  <a href="#" id="thumb-icon" data-toggle="image" class="img-thumbnail">
		                  	<img <?php if($common['SITE_ICON']['value']): ?> 
								...
								<?php else: ?>  
								src="__PUBLIC__/image/no_image_40x40.jpg" 
								<?php endif; ?>  />
								</a>
