<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin\view\goods\general.html";i:1512525352;s:41:"./application/admin\view\public\base.html";i:1512537585;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		                ...
		                <div class="col-sm-10" id="thumb">
		                  <a id="thumb-image" href="#" data-toggle="image" class="img-thumbnail">
		                  		<?php if(!empty($goods['image'])): ?>
		                  			<img src="IMG_ROOT<?php echo resize($goods['image'],100,100); ?>" />
			                  	<?php else: ?>
