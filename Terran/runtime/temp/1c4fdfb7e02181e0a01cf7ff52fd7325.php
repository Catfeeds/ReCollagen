<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"./oscshop/admin\view\goods\edit.html";i:1512525352;s:37:"./oscshop/admin\view\public\base.html";i:1512537585;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
function addOptionValue(option_row,type) {	
	...
	if(type=='select'){
		...
		html+= '  <td class="text-left"><a href="#" id="option-image-row' + option_value_row + '"data-toggle="image" class="img-thumbnail"><img src="__PUBLIC__/image/no_image_100x100.jpg" /><input type="hidden" name="goods_option[' + option_row + '][goods_option_value][' + option_value_row + '][option_value_image]" value="" id="option-input-image' + option_value_row + '" /></td>';
	}
