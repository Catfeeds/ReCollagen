<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./oscshop/member\view\auth_backend\index.html";i:1512525352;s:37:"./oscshop/admin/view/public/base.html";i:1512537585;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>													
							<td>
								<a href='<?php echo url("AuthBackend/edit_group",array("id"=>$d["id"])); ?>'>
									<?php echo $d['title']; ?>
								</a> 
							</td>
							...
							<td>							
							<?php switch($d['status']): case "1": ?><a href='<?php echo url("AuthBackend/set_status",array("id"=>$d["id"],"status"=>0)); ?>'><span class="btn btn-xs btn-success"><i class="fa fa-check bigger-120"></i></span></a><?php break; case "0": ?><a href='<?php echo url("AuthBackend/set_status",array("id"=>$d["id"],"status"=>1)); ?>'><span class="btn btn-xs btn-danger"><i class="fa fa-remove bigger-120"></i></span></a><?php break; endswitch; ?>
								
							</td>
							<td>
								
								<a class="delete btn btn-xs btn-danger" href='<?php echo url("AuthBackend/del_group",array("id"=>$d["id"])); ?>' >
