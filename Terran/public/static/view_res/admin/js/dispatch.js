$(function(){
	...
	TransTpl += "<table cellspacing=\"0\" class=\"ncsc-table-style\" cellpadding=\"0\" border=\"0\">\n";
	TransTpl += "<tr class=\"bd-line\" data-group=\"n1\">\n";
	...
	// TransTpl += "<i class=\"icon-map-marker\"></i>设置/清空发货范围<\/a>\n";
	...
	//单行内容模板
	// RuleCell += "<tr class=\"bd-line\" data-group=\"n1\">\n";
	// RuleCell += "<td class=\"cell-area\">\n";
	// RuleCell += "<span class=\"area-group\">\n";
	// RuleCell += "<input class=\"J_BatchField\" style=\"width:15px; display:none\" type=\"checkbox\" value=\"\" name=\"TRANSTYPE_n1\">\n";
	// RuleCell += "<p style=\"display:inline-block\">未添加地区<\/p><\/span>\n";
	// RuleCell += "<input type=\"hidden\" value=\"\" name=\"areas[kd][1]\">\n";
	// RuleCell += "<\/td>\n";
	// RuleCell += "<td class=\"nscs-table-handle\">\n";
	// RuleCell += "<span>\n";
	// RuleCell += "<a class=\"btn-red J_DeleteRule\" ncNum=\"n1\" href=\"JavaScript:void(0);\">\n";
	// RuleCell += "<i class=\"icon-trash\"><\/i><p>删除<\/p>\n";
	// RuleCell += "<\/a>\n";
	// RuleCell += "<\/span>\n";
	// RuleCell += "<span>\n";
	// RuleCell += "<a class=\"btn-blue\" data-group=\"n1\" title=\"编辑运送区域\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">\n";
