$(function(){
    ...
    TransTpl += "默认首重运费(元)：\n";
 	// TransTpl += "<input class=\"w30 mr5 text\" type=\"text\" aria-label=\"默认运费"+1112+"数\" maxlength=\"4\" autocomplete=\"off\" data-field=\"start\" value=\"1\" name=\"default[TRANSTYPE][start]\">\n";
	// TransTpl += ""+111+"内，\n";
	TransTpl += "<input style=\"width: 60%;\" class=\"text\" type=\"text\" aria-label=\"默认运费价格\" maxlength=\"6\" autocomplete=\"off\" value=\"\" name=\"default[TRANSTYPE][postage]\" data-field=\"postage\">";
    ...
    TransTpl += "续费运费(元)：\n";
	TransTpl += "<input style=\"width: 60%;\" class=\"ml5 text\" type=\"text\" aria-label=\"加重运费\" maxlength=\"6\" autocomplete=\"off\" value=\"\" data-field=\"postageplus\" name=\"default[TRANSTYPE][postageplus]\">";
	// TransTpl += "<em class=\"add-on\">";
	TransTpl += "<i class=\"icon-renminbi\"><\/i>";
	TransTpl += "<\/em>\n";
	...
	RuleHead += "<tr>\n";
	RuleHead += "<th>运送到<\/th>\n";
	// RuleHead += "<th class=\"w60\">首重("+11+")<\/th>\n";
	RuleHead += "<th class=\"w110\">首费(元)<\/th>\n";
	// RuleHead += "<th class=\"w60\">续重("+11+")<\/th>\n";
...
//	RuleCell += "<a class=\"ncu-btn2\" title=\"编辑运送区域\" area-haspopup=\"true\" area-controls=\"J_DialogArea\" entype=\'J_EditArea\' data-acc=\"event:enter\" href=\"JavaScript:void(0);\">编辑<\/a>\n";
	...
	RuleCell += "<p style=\"white-space: nowrap;\">删除<\/p>\n";
	RuleCell += "<\/a>\n";
	RuleCell += "<\/span>\n";
	RuleCell += "<span>\n";
	...
	RuleCell += "<p style=\"white-space: nowrap;\">编辑<\/p>\n";
	RuleCell += "<\/a>\n";	
	RuleCell += "<\/span>\n";
	RuleCell += "<\/td>\n";
	RuleCell += "<\/tr>\n";
