...
-- ----------------------------
INSERT INTO `osc_admin` VALUES ('1', 'admin', 'MDAwMDAwMDAwMLO6d61/iaja', '', '', 'admin@admin.com', '41', '127.0.0.1', '', '1505270345', '1513412152', '1515035484', '1', '2');
...
INSERT INTO `osc_goods` VALUES ('34', '0', '35', 'images/osc1/product/2@theme.png', '八宝莲子200克', '9.91', '9987', '0', '100.00', '0.01', '2017-12-16 09:25:07', '2017-12-29 13:17:23', '1', '1');
...
CREATE TABLE `osc_menu` (
  ...
  PRIMARY KEY (`id`),
  KEY `pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=340 DEFAULT CHARSET=utf8 COMMENT='后台菜单';
...
INSERT INTO `osc_order` VALUES ('18', 'AC23128906334088', '3', 'http://wxadmin.edeapp.com/public/uploads/images/osc1/3/2.jpg', '公道杯茶海分茶器陶瓷等', '2', '哈哈哈', '13333333333', '江苏省南京市玄武区明珠广场22号', '1', '物流公司名称', '', '0.00', '0.00', '317.00', '9.91', '6.00', '332.91', '[{\"name\":\"周年庆限时满300返现30\",\"type\":2,\"money\":300,\"expression\":\"30\"},{\"name\":\"限时满200赠送悦寇霖智美白防晒霜一瓶\",\"type\":3,\"money\":200,\"expression\":\"限时满200赠送悦寇霖智美白防晒霜一瓶\"}]', '0', '1514012890', '1514509166');
...
CREATE TABLE `osc_user_action` (
  ...
  PRIMARY KEY (`ua_id`)
) ENGINE=InnoDB AUTO_INCREMENT=842 DEFAULT CHARSET=utf8 COMMENT='用户行为';
