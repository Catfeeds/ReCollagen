...
Route::get('api/:version/cart/preOrder/checked/:checked','api/:version.Cart/getPreOrderDetail');   //获取预下单详情清单
...
Route::post('api/:version/order/del', 'api/:version.Order/delOrder');                   //删除订单
